...
## Last Updated
April 21, 2026 at 02:07:29 AM UTC
...
- [Neural Network Quantization for Microcontrollers: A Comprehensive Survey of Methods, Platforms, and Applications](https://arxiv.org/abs/2508.15008)
- [NanoCockpit: Performance-optimized Application Framework for AI-based Autonomous Nanorobotics](https://arxiv.org/abs/2601.07476)
- [TinyML-Enabled IoT for Sustainable Precision Irrigation](https://arxiv.org/abs/2601.13054)
- [Rethinking Temporal Models for TinyML: LSTM versus 1D-CNN in Resource-Constrained Devices](https://arxiv.org/abs/2603.04860)
- [Scaling Laws in the Tiny Regime: How Small Models Change Their Mistakes](https://arxiv.org/abs/2603.07365)
- [Energy-Aware Multi-Exit TinyML for Smart Zero-Energy Devices](https://arxiv.org/abs/2603.08047)
- [Affordable Precision Agriculture: A Deployment-Oriented Review of Low-Cost, Low-Power Edge AI and TinyML for Resource-Constrained Farming Systems](https://arxiv.org/abs/2603.15085)
- [Once-for-All Channel Mixers (HYPERTINYPW): Generative Compression for TinyML](https://arxiv.org/abs/2603.24916)
- [TinyML for Acoustic Anomaly Detection in IoT Sensor Networks](https://arxiv.org/abs/2603.26135)
- [Fully Autonomous Z-Score-Based TinyML Anomaly Detection on Resource-Constrained MCUs Using Power Side-Channel Data](https://arxiv.org/abs/2604.08581)
- [Co-Design of CNN Accelerators for TinyML using Approximate Matrix Decomposition](https://arxiv.org/abs/2604.16113)
